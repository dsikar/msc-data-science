...
% Auto-generated by MATLAB on 12-Nov-2019 16:49:33
...
template = templateTree(... % Maximal number of decision splits (or branch nodes) per tree
    'MaxNumSplits', 1043); % see INM431/labs/week07/RandomForestCodeImplementation/RTreeClass.m 
    % RT.m_numNodes = int32(2^(maxDepth+1)) - 1; %get max number of nodes 2^11 - 1 = 2047
    % NB in RTreeClass.m, this is set as a function of maxDepth
