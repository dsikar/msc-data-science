...
% FIFTH RUN
% 1. Leave targets are double for training
% 3rd run TP = 78, TN = 3, FP = 23, FN = 0, worst so far
% 4th run TP = 77, TN = 3, FP = 22, FN = 2
% 5th failed, reverted to categorical
% 6th run TP = 85, TN = 1, FP = 18, FN = 0, even worse
...
%trainingData = Table2Categorical(trainingData, isCategoricalPredictor(1,:));
