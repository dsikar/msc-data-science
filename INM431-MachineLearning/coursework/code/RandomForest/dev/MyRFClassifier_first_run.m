...
% FIRST RUN
% 1. response labels as 'double'
% 2. only a few columns categorical
% 3. majority class being predicted ok, minority class not so goods
% TP = 78, TN = 5, FP = 14, FN = 7
...
% Reached a best model, now excluding in turn G2 and G1 (previous grades,
% before final pass/fail grade G3)
